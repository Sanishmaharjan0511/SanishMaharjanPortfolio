...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        <img src="assets/img/self.jpg" alt="" class="img-fluid rounded-circle" style="top center" >
        <h1 class="text-light"><a href="index.html">Sanish Maharjan</a></h1>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>12 March 2000</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong> <span>sanish-maharjan.com.np</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>+977 9841306385</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span>Bholdhoka, Lalitpur, Nepal</span></li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Age:</strong> <span>23</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Degree:</strong> <span>B.I.T(HONS) Computing</span></li>
      ...
      <div class="container">
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6" data-aos="fade-up">
            ...
            <div class="progress">
              <span class="skill">Gitlab <i class="val">85%</i></span>
              <div class="progress-bar-wrap">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="progress">
              <span class="skill">HTML and CSS <i class="val">80%</i></span>
              <div class="progress-bar-wrap">
        ...
        <div class="row">
          <div class="col-lg-6" data-aos="fade-up">
            ...
            <div class="resume-item pb-0">
              ...
              <ul>
                <li>Bholdhoka, Lalitpur, Nepal</li>
                <li>+977 9841306385</li>
                <li>mehiopsss@gmail.com</li>
              </ul>
            </div>

            <h3 class="resume-title">Education</h3>
            <div class="resume-item">
              <h4>B.I.T (HONS) Computing</h4>
              <h5>2018 - 2021</h5>
              <p><em>Islington College, Kamalpokhari, Nepal</em></p>
             
            </div>
            <div class="resume-item">
              <h4>+2 (NEB)</h4>
              <h5>2016 - 2018</h5>
              <p><em>D.A.V College, Jawalakhel, Nepal</em></p>
            </div>
            <div class="resume-item">
              <h4>S.L.C (GON)</h4>
              <h5>2016 - 2018</h5>
              <p><em>Future Stars High School, Jawalakhel, Nepal</em></p>
            </div>
          </div>
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="resume-item">
              ...
              <p><em>EKbana | Kupondole </em></p>
              <ul>
                <li>Proved successful working within tight deadlines and a fast-paced environment. </li>
                ...
                <li> Adaptable and proficient in learning new concepts quickly and efficiently</li>
              </ul>
            </div>
            <div class="resume-item">
              <h4>Front-End Developer (Intern)</h4>
              <h5>Nov 2020 – Feb 2021</h5>
              <p><em>Sansri Technologies | Nagpokhari</em></p>
              <ul>
                <li>Developed and maintained courteous and effective working relationships.</li>
                <li>Gained strong leadership skills by managing projects from start to finish.</li>
                <li>Applied effective time management techniques to meet tight deadlines.</li>
                <li>Delivered services to customer locations within specific timeframes.</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>Bholdhoka, Lalitpur, Nepal </p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                <p>mehiopsss@gmail.com</p>
              </div>
